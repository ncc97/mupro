  ...
  * ================================= */
  ...
  , focus: function (items) {
		...
		for(var i=0;i<this.source.length;i++){
			...
			$("<li data-value='"+this.source[i]+"'><a href='#'>"+this.source[i]+"</a></li>").appendTo(this.$menu)
		}
  ...
  * ================== */
  ...
  $(function () {
    $('body').on('focus.typeahead.data-api', '[data-provide="typeahead"]', function (e) {
      var $this = $(this)
	  if($this.attr('data-source')) $this.attr('data-source',$this.attr('data-source').replace(/\'/g,"\""))
